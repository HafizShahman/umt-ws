<div class="topbar-nav header navbar" role="banner">
    <nav id="topbar">
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu  <?php echo e(Request::routeIs('dashboard' || 'superadmindashboard') ? 'active' : ''); ?>">
            ...
            <?php if(Auth::user()->role_id == 2 || Auth::user()->role_id == 4): ?>
                <li class="menu single-menu  <?php echo e(Request::routeIs('feedbacktable') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('feedbacktable')); ?>">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
<?php /**PATH C:\laragon\www\umt\resources\views/general/inc/topbar.blade.php ENDPATH**/ ?>